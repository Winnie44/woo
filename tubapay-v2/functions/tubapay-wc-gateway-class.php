...
Wpadnij na kawkę: https://tubapay.pl/';
        ...
        {
            $this->id = 'tubapay2';
            $this->icon = add_filter( 'woocommerce_gateway_icon', 'custom_gateway_icon', 10, 2 );;
...
//             $order->payment_complete();
        ...
        public function getSelectInstallmentsInputForAmount($amount)
        {
            ...
            foreach ($installments as $installment) {
                ...
                $html .= '<div style="align-items: flex-start !important;gap: 3px !important;margin-bottom: 10px !important;display:flex !important;">
